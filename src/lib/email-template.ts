...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { background: linear-gradient(135deg, #1A1A1A 0%, #0A0A0A 100%); padding: 48px 40px; text-align: center; border-bottom: 2px solid #FF5C1A; }
    .logo { font-size: 13px; letter-spacing: 4px; color: #FF5C1A; text-transform: uppercase; margin-bottom: 24px; }
    ...
    .score-number { font-size: 72px; font-weight: 900; color: #FF5C1A; line-height: 1; }
    ...
    .prioridade-item { background: #1A1A1A; border-radius: 8px; padding: 14px 16px; margin-bottom: 10px; font-size: 14px; color: #F5EFE0; line-height: 1.6; border-left: 3px solid #FF5C1A; }
    .cta-box { background: linear-gradient(135deg, #FF5C1A, #FF7A42); margin: 0 40px 40px; border-radius: 16px; padding: 32px; text-align: center; }
    ...
    .cta-button { display: inline-block; background: white; color: #FF5C1A; padding: 14px 32px; border-radius: 8px; font-weight: 700; font-size: 15px; text-decoration: none; }
